<template>
  <v-container>
    <v-data-table :headers="headers" :items="logs" :server-items-length="totalLogs" :loading="loading"
      :items-per-page.sync="itemsPerPage" :page.sync="page" :options.sync="options" @update:page="fetchLogs"
